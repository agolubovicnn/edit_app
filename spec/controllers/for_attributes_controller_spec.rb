...
RSpec.describe ForAttributesController, :type => :controller do

  # This should return the minimal set of attributes required to create a valid
  # ForAttribute. As you add validations to ForAttribute, be sure to
  ...
  # ForAttributesController. Be sure to keep this updated too.
  let(:valid_session) { {} }

  describe "GET index" do
    it "assigns all for_attributes as @for_attributes" do
      for_attribute = ForAttribute.create! valid_attributes
      get :index, {}, valid_session
      expect(assigns(:for_attributes)).to eq([for_attribute])
    end
  end
  ...
  describe "GET show" do
    it "assigns the requested for_attribute as @for_attribute" do
      for_attribute = ForAttribute.create! valid_attributes
      get :show, {:id => for_attribute.to_param}, valid_session
  ...
  describe "GET edit" do
    it "assigns the requested for_attribute as @for_attribute" do
      for_attribute = ForAttribute.create! valid_attributes
      get :edit, {:id => for_attribute.to_param}, valid_session
      expect(assigns(:for_attribute)).to eq(for_attribute)
    end
  end
